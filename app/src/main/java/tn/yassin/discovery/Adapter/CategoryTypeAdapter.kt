...
class CategoryTypeAdapter(var context: Context) : RecyclerView.Adapter<CategoryTypeAdapter.ViewHolder>() {
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        val PicExploreCateg : ImageView = itemView.findViewById<ImageView>(R.id.imgcategType)
        val PlaceName : TextView = itemView.findViewById<TextView>(R.id.PlaceNamecategType)
        val LieuxPlace : TextView = itemView.findViewById<TextView>(R.id.LieuxPlacecategType)
        val ratingBar : RatingBar = itemView.findViewById<RatingBar>(R.id.ratingBarcategType)
        val numbComment : TextView = itemView.findViewById<TextView>(R.id.numbCommentcategType)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder  {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_categorytype, parent, false)
